...
<body translate="yes">
    ...
    <main style="margin-top:100px;">
        <h1 class="translate" translate="yes">Para hacer selfi</h1>

        <h3 class="translate" translate="yes">Para vuestro Instagram</h3>
        ...
        <div class="carrousel">
            ...
            <div class="images" data-carrousel="first" data-time="7">
                ...
                try {
                    $resultat = $cnx->prepare("SELECT lieu, img, likes, message FROM spotses");
