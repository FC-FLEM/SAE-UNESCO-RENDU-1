...
<body>
    ...
    <div class="contenu">
        <h1>Itinerarios a Granada</h1>

        <form class="formcarte">
            <fieldset>
                <legend>Ustedes tipos de Itinerarios</legend>
                <input type="radio" name="culture" value="Detente" id="detente" checked><label for="detente">Relajación</label>
                <input type="radio" name="culture" value="Famille" id="famille"><label for="famille">Con familia</label>
                <input type="radio" name="culture" value="Party" id="fete"><label for="fete">Fiesta</label>
                <input type="radio" name="culture" value="Melancolie" id="melancolie"><label for="melancolie">Melancolía</label>
            </fieldset>
            <br>
            <fieldset>
                <legend>Duracion del viaje</legend>
                <input type="radio" name="duree" value="1h" id="1h" checked><label for="1h">1 hora</label>
                <input type="radio" name="duree" value="2h" id="2h"><label for="2h">2 horas</label>
                <input type="radio" name="duree" value="4h" id="4h"><label for="4h">4 horas</label>
            </fieldset>
            <br>
            <fieldset>
                <legend>Manana o Noche</legend>
                <input type="radio" name="moment" value="Nuit" id="Nuit" checked><label for="Nuit">Noche</label>
                <input type="radio" name="moment" value="Jour" id="Jour"><label for="Jour">Manana</label>
            </fieldset>
            <br>
            <input type="submit" class="btncarte" value="Ver la mapa">
        </form>
